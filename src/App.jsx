...
const THEMES={
  ...
  barbie:{name:'Barbie',emoji:'💖','--bg':'#fff0f8','--card':'#ffffff','--text':'#880044','--text2':'#cc6699','--border':'#ffccee','--hover':'#fff5fb','--sidebar':'#4A0023','--input':'#fff0f8','--shadow':'0 2px 20px rgba(255,105,180,0.2)','--primary':'#ff1493','--success':'#ff69b4','--warning':'#ffb347',sidebarEmoji:'👛',sidebarBg:'#ff69b4',sidebarDark:true,decoration:['💖','✨','👠']},
