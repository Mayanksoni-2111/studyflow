...
.unicorn-bg{background-color:#f3e0ff;background-image:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='120' height='90' viewBox='0 0 120 90'><g fill='%23c084fc' opacity='0.45'><path d='M5 85 Q30 10 60 10 Q90 10 115 85'/><path d='M10 85 Q33 22 60 22 Q87 22 110 85'/><path d='M15 85 Q36 34 60 34 Q84 34 105 85'/><path d='M20 85 Q39 46 60 46 Q81 46 100 85'/></g><g fill='%23e879f9' opacity='0.3'><path d='M20 18 L22 13 L24 18 L29 18 L25 21 L27 26 L22 23 L17 26 L19 21 L15 18Z'/><path d='M95 55 L97 50 L99 55 L104 55 L100 58 L102 63 L97 60 L92 63 L94 58 L90 55Z'/><path d='M55 6 L56.5 2 L58 6 L62 6 L59 8 L60 12 L56.5 10 L53 12 L54 8 L51 6Z'/><path d='M8 60 L9.5 56 L11 60 L15 60 L12 62 L13 66 L9.5 64 L6 66 L7 62 L4 60Z'/></g></svg>");background-size:120px 90px;}.barbie-bg{background-color:#ff69b4;background-image:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='100' height='100' viewBox='0 0 100 100'><g fill='%23ff1493' opacity='0.45'><path d='M50 75 C50 75 15 52 15 30 C15 18 24 12 34 18 C40 12 50 10 50 10 C50 10 60 12 66 18 C76 12 85 18 85 30 C85 52 50 75 50 75Z'/></g><g fill='%23c2185b' opacity='0.35'><path d='M82 22 C82 22 72 15 72 9 C72 6 75 4 78 7 C80 4 85 4 85 9 C85 15 82 22 82 22Z'/><path d='M18 78 C18 78 8 71 8 65 C8 62 11 60 14 63 C16 60 21 60 21 65 C21 71 18 78 18 78Z'/></g><g fill='%23880044' opacity='0.25'><path d='M25 95 L25 80 L35 90 L50 72 L65 90 L75 80 L75 95Z'/></g></svg>");background-size:100px 100px;}.anime-bg{background-color:#1a0a00;background-image:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='120' height='120' viewBox='0 0 120 120'><g fill='%23ffb7c5' opacity='0.4'><path d='M60 18 C66 6 76 8 74 20 C72 32 62 42 60 50 C58 42 48 32 46 20 C44 8 54 6 60 18Z'/><path d='M80 38 C92 32 96 42 86 48 C76 54 64 52 58 52 C62 46 72 38 80 38Z'/><path d='M75 68 C84 78 78 88 68 82 C58 76 52 64 50 58 C56 56 68 60 75 68Z'/><path d='M45 68 C36 78 42 88 52 82 C62 76 68 64 70 58 C64 56 52 60 45 68Z'/><path d='M40 38 C28 32 24 42 34 48 C44 54 56 52 62 52 C58 46 48 38 40 38Z'/><path d='M60 50 A6 6 0 1 1 59.9 50Z'/></g><g fill='%23ff9eb5' opacity='0.3'><path d='M100 15 C103 9 108 10 107 16 C106 22 101 26 100 29 C99 26 94 22 93 16 C92 10 97 9 100 15Z'/><path d='M108 23 C114 20 116 25 111 28 C106 31 101 30 99 30 C100 27 104 23 108 23Z'/><path d='M105 35 C110 40 107 45 102 42 C97 39 94 33 93 31 C96 30 101 33 105 35Z'/><path d='M95 35 C90 40 93 45 98 42 C103 39 106 33 107 31 C104 30 99 33 95 35Z'/><path d='M92 23 C86 20 84 25 89 28 C94 31 99 30 101 30 C100 27 96 23 92 23Z'/></g><g fill='%23ff6400' opacity='0.35'><path d='M10 120 L10 75 M30 120 L30 75'/><path d='M5 75 L35 75 M7 68 L33 68'/><path d='M12 75 L28 75'/></g></svg>");background-size:120px 120px;}.nature-bg{background-color:#e8f5e8;background-image:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='110' height='110' viewBox='0 0 110 110'><g fill='%232e7d32' opacity='0.3'><path d='M55 100 C55 100 20 72 20 42 C20 18 38 10 55 26 C72 10 90 18 90 42 C90 72 55 100 55 100Z'/><path d='M55 100 L55 26'/><path d='M55 50 Q40 44 30 46'/><path d='M55 60 Q38 56 26 60'/><path d='M55 70 Q40 68 32 74'/><path d='M55 50 Q70 44 80 46'/><path d='M55 60 Q72 56 84 60'/><path d='M55 70 Q70 68 78 74'/></g><g fill='%2343a047' opacity='0.25'><path d='M18 30 C18 30 6 20 8 10 C9 4 15 2 18 9 C21 2 27 4 28 10 C30 20 18 30 18 30Z'/><path d='M18 30 L18 9'/><path d='M92 25 C92 25 102 14 100 5 C99 -1 93 -2 92 5 C91 -2 85 -1 84 5 C82 14 92 25 92 25Z'/><path d='M92 25 L92 5'/></g><g fill='%2366bb6a' opacity='0.2'><path d='M20 85 A4 4 0 1 1 19.9 85Z'/><path d='M88 70 A4 4 0 1 1 87.9 70Z'/><path d='M12 60 A3 3 0 1 1 11.9 60Z'/><path d='M100 40 A3 3 0 1 1 99.9 40Z'/><path d='M30 10 A3 3 0 1 1 29.9 10Z'/></g></svg>");background-size:110px 110px;}.cars-bg{background-color:#0a0a0a;background-image:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='80' height='80' viewBox='0 0 80 80'><g fill='%23ffffff' opacity='0.14'><path d='M0 0 H20 V20 H0Z M20 20 H40 V40 H20Z M40 0 H60 V20 H40Z M60 20 H80 V40 H60Z'/><path d='M0 40 H20 V60 H0Z M20 60 H40 V80 H20Z M40 40 H60 V60 H40Z M60 60 H80 V80 H60Z'/></g><g fill='%23ff3200' opacity='0.3'><path d='M8 75 C8 75 2 60 6 48 C8 40 14 40 14 50 C16 38 22 35 20 50 C24 38 28 42 24 55 C28 46 34 50 28 62 C32 55 36 60 30 70 C24 65 16 68 8 75Z'/><path d='M72 75 C72 75 78 60 74 48 C72 40 66 40 66 50 C64 38 58 35 60 50 C56 38 52 42 56 55 C52 46 46 50 52 62 C48 55 44 60 50 70 C56 65 64 68 72 75Z'/></g><g fill='%23ffcc00' opacity='0.2'><path d='M0 35 L80 30 M0 42 L80 37 M0 49 L80 44'/></g></svg>");background-size:80px 80px;}.avengers-bg{background-color:#0d1117;background-image:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='120' height='120' viewBox='0 0 120 120'><g fill='%23c62828' opacity='0.35'><path d='M60 8 A52 52 0 1 1 59.9 8Z'/></g><g fill='%231565c0' opacity='0.3'><path d='M60 18 A42 42 0 1 1 59.9 18Z'/></g><g fill='%23e0e0e0' opacity='0.15'><path d='M60 28 A32 32 0 1 1 59.9 28Z'/></g><g fill='%23f9a825' opacity='0.6'><path d='M68 8 L44 56 L62 56 L36 112 L80 50 L62 50Z'/></g><g fill='%23ffffff' opacity='0.5'><path d='M60 32 L63 43 L75 43 L65 50 L69 61 L60 54 L51 61 L55 50 L45 43 L57 43Z'/></g></svg>");background-size:120px 120px;}.light-bg{background-color:#F4F3FF;background-image:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='60' height='52' viewBox='0 0 60 52'><g fill='%236C63FF' opacity='0.07'><path d='M30 4 L52 16 L52 40 L30 52 L8 40 L8 16Z M30 4 L52 16 M52 16 L52 40 M52 40 L30 52 M30 52 L8 40 M8 40 L8 16 M8 16 L30 4'/></g><g fill='%23a78bfa' opacity='0.06'><path d='M30 18 L33 26 L41 26 L35 31 L37 39 L30 34 L23 39 L25 31 L19 26 L27 26Z'/></g></svg>");background-size:60px 52px;}.dark-bg{background-color:#0f0f1a;background-image:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='120' height='120' viewBox='0 0 120 120'><g fill='%237B74FF' opacity='0.35'><path d='M20 20 A3 3 0 1 1 19.9 20Z'/><path d='M70 55 A4 4 0 1 1 69.9 55Z'/><path d='M40 90 A2 2 0 1 1 39.9 90Z'/><path d='M95 15 A3 3 0 1 1 94.9 15Z'/><path d='M10 70 A2 2 0 1 1 9.9 70Z'/><path d='M55 30 A1.5 1.5 0 1 1 54.9 30Z'/><path d='M100 80 A2 2 0 1 1 99.9 80Z'/><path d='M30 50 A1.5 1.5 0 1 1 29.9 50Z'/><path d='M85 40 A1.5 1.5 0 1 1 84.9 40Z'/><path d='M5 35 A2 2 0 1 1 4.9 35Z'/><path d='M115 60 A2.5 2.5 0 1 1 114.9 60Z'/><path d='M60 105 A1.5 1.5 0 1 1 59.9 105Z'/></g><g fill='%23A78BFA' opacity='0.3'><path d='M108 25 L110 20 L112 25 L117 27 L112 29 L110 34 L108 29 L103 27Z'/><path d='M15 95 L17 90 L19 95 L24 97 L19 99 L17 104 L15 99 L10 97Z'/><path d='M75 8 L77 4 L79 8 L83 10 L79 12 L77 16 L75 12 L71 10Z'/></g><g fill='%234f46e5' opacity='0.2'><path d='M88 80 A18 18 0 1 1 88 116 A12 12 0 1 0 88 80Z'/></g></svg>");background-size:120px 120px;}
